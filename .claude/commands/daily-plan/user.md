...
3. Read mission-control/data/inbox.json for new delegations and messages
4. Read mission-control/data/decisions.json for pending decisions needing my input
5. Read mission-control/data/brain-dump.json for items needing triage
6. Read mission-control/data/goals.json for upcoming milestone deadlines
